...
TEST_CASE("ip case 0", "[ip]") {
    ...
    std::string var_str = "x0, lb=1700, ub=5900, len=43, idx=0\n"
        "x1, lb=3000, ub=7300, len=44, idx=0\n"
        "x2, lb=0, ub=4300, len=44, idx=0\n"
        "x3, lb=0, ub=0, len=1, idx=0\n"
        "x4, lb=0, ub=0, len=1, idx=0\n"
        "x5, lb=0, ub=0, len=1, idx=0";
...
TEST_CASE("ip case 1 hit avg price", "[ip]") {
    ...
    solver.SetConstraintCoefs(0, {1L, 1L, 1L, -1L, -1L, -1L});
    solver.SetConstraintCoefs(1, {100L, 200L, 300L, -100L, -200L, -300L});
...
TEST_CASE("ip case 1", "[ip]") {
    ...
    std::string var_str = 
        "x0, lb=1100, ub=21400, len=204, idx=0\n"
        "x1, lb=100, ub=20600, len=206, idx=0\n"
        "x2, lb=1700, ub=22200, len=206, idx=0\n"
        "x3, lb=0, ub=17100, len=172, idx=0\n"
        "x4, lb=0, ub=14200, len=143, idx=0\n"
        "x5, lb=0, ub=0, len=1, idx=0\n"
        "x6, lb=0, ub=0, len=1, idx=0\n"
        "x7, lb=0, ub=0, len=1, idx=0\n"
        "x8, lb=0, ub=3400, len=35, idx=0\n"
        "x9, lb=0, ub=6300, len=64, idx=0";
...
TEST_CASE("ip case 3", "[ip]") {
    ...
    solver.SetConstraintCoefs(0, {1L, 1L, -1L, -1L});
    solver.SetConstraintCoefs(1, {112400L, 112500L, -112400L, -112500L});
